...
public class AddWordMessageBuilder extends MessageBuilder{
    ...
    public String getResponseMessageText(String messageText) {
        ...
        if(null!=dictionaryService.getWordRepository().findByEnglishValue(wordData[0])) {
            Word wordInDictionary = dictionaryService.getWordRepository().findByEnglishValue(wordData[0]);
